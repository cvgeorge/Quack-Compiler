...
typedef struct Class_Factorial Class_Factorial;
typedef struct Object_Factorial Object_Factorial;
...
struct Class_Factorial{
	Object_Factorial* (*Class_Factorial_Method_Factorial)();
	Object_Str* (*Class_Obj_Method_STR)(Object_Obj* _this_ptr);
	Object_Nothing* (*Class_Obj_Method_PRINT)(Object_Obj* _this_ptr);
	Object_Int* (*Class_Factorial_Method_fact)(Object_Factorial* _this_ptr, Object_Int* num);
} ;

struct Object_Factorial{
	Class_Factorial *_class_pointer;
} ;
	...
	Class_Factorial	GLOBAL_Class_Factorial;
...
// Adding Arguments to the named map 
// allocating variables.
	Object_Factorial * returnValue = (Object_Factorial * )malloc(sizeof(Object_Factorial));
	returnValue->_class_pointer = &GLOBAL_Class_Factorial;
	return returnValue;
...
// Generate Typed Value 
	...
	Int_gen_5->_int_value = 1;
	Int_gen_4 = ((Object_Int* )Int_gen_5); // return value .
	Int_gen_4->_class_pointer= &GLOBAL_Class_Int;
	return Int_gen_4;
	goto label_0_;
	}
// end code block
...
// Begin Method Call Generation .
	Object_Factorial* Factorial_gen_0 = NULL; // Default New Var reg of type: Factorial
	Factorial_gen_0 = ( (Object_Factorial* )_this_ptr); 
...
// Before Left Math Eval.
	...
	Int_gen_12 = ( (Object_Int* )num); 
// Setting variable num to the new value
	num = Int_gen_12;
// After Left Math Eval.
	Int_gen_11 = Int_gen_12; // evaled left of expression.
	Object_Int* Int_gen_13 = NULL; // Default New Var reg of type: Int
// Before Right Math Eval.
// Generate Typed Value 
	Object_Int* Int_gen_14 = NULL; // Default New Var reg of type: Int
	Int_gen_14 = (*GLOBAL_Class_Int.Class_Int_Method_Int)();
	Int_gen_14->_int_value = 1;
// After Right  Math Eval.
	Int_gen_13 = Int_gen_14; // evaled right of expression.
	Object_Int* Int_gen_15 = NULL; // Default New Var reg of type: Int
	Int_gen_15 = (*Int_gen_11->_class_pointer->Class_Int_Method_MINUS)(Int_gen_11, Int_gen_13);
	Int_gen_10 = Int_gen_15; // evaluated argument 
	Object_Int* Int_gen_16 = NULL; // Default New Var reg of type: Int
	Int_gen_16 = ( (Object_Int* )Int_gen_10); 
	Object_Int* Int_gen_17 = NULL; // Default New Var reg of type: Int
	Int_gen_17 = (*_this_ptr->_class_pointer->Class_Factorial_Method_fact)(Factorial_gen_0,Int_gen_16);
// After Right  Math Eval.
	Int_gen_9 = Int_gen_17; // evaled right of expression.
	Object_Int* Int_gen_18 = NULL; // Default New Var reg of type: Int
	Int_gen_18 = (*Int_gen_7->_class_pointer->Class_Int_Method_TIMES)(Int_gen_7, Int_gen_9);
	Int_gen_6 = ((Object_Int* )Int_gen_18); // return value .
	Int_gen_6->_class_pointer= &GLOBAL_Class_Int;
	return Int_gen_6;
...
// Adding Arguments to the named map 
// allocating variables.
	Object_Factorial* Factorial_gen_1 = NULL; // Default New Var reg of type: Factorial
	Object_Int* Int_gen_19 = NULL; // Default New Var reg of type: Int
	Object_Factorial* Factorial_gen_2 = NULL; // Default New Var reg of type: Factorial
// Begin Assignment Gen Value side. 
// Begin Method Call Generation .
	Object_Factorial* Factorial_gen_3 = NULL; // Default New Var reg of type: Factorial
	Factorial_gen_3 = (*GLOBAL_Class_Factorial.Class_Factorial_Method_Factorial)();
	Factorial_gen_2 = Factorial_gen_3 ; // Assignment value, evaled.
// emit a store instruction into a local 'variable' 
	Object_Factorial* Factorial_gen_4 = NULL; // Default New Var reg of type: Factorial
	Factorial_gen_4 = ( (Object_Factorial* )Factorial_gen_2); 
	 // Assigning var fact_class to Factorial_gen_4
	Factorial_gen_1 = Factorial_gen_4;
// End Assignment Statment
	Object_Int* Int_gen_20 = NULL; // Default New Var reg of type: Int
// Begin Assignment Gen Value side. 
// Begin Method Call Generation .
	Object_Factorial* Factorial_gen_5 = NULL; // Default New Var reg of type: Factorial
	Object_Factorial* Factorial_gen_6 = NULL; // Default New Var reg of type: Factorial
	Factorial_gen_6 = ( (Object_Factorial* )Factorial_gen_1); 
// Setting variable Factorial_gen_1 to the new value
	Factorial_gen_1 = Factorial_gen_6;
Factorial_gen_5 = Factorial_gen_6; // generate method left exp complete.
	Object_Factorial* Factorial_gen_7 = NULL; // Default New Var reg of type: Factorial
	Factorial_gen_7 = ( (Object_Factorial* )Factorial_gen_5); 
	Object_Int* Int_gen_21 = NULL; // Default New Var reg of type: Int
// Generate Typed Value 
	Object_Int* Int_gen_22 = NULL; // Default New Var reg of type: Int
	Int_gen_22 = (*GLOBAL_Class_Int.Class_Int_Method_Int)();
	Int_gen_22->_int_value = 7;
	Int_gen_21 = Int_gen_22; // evaluated argument 
	Object_Int* Int_gen_23 = NULL; // Default New Var reg of type: Int
	Int_gen_23 = ( (Object_Int* )Int_gen_21); 
	Object_Int* Int_gen_24 = NULL; // Default New Var reg of type: Int
	Int_gen_24 = (* Factorial_gen_7->_class_pointer->Class_Factorial_Method_fact)(Factorial_gen_7,Int_gen_23);
	Int_gen_20 = Int_gen_24 ; // Assignment value, evaled.
// emit a store instruction into a local 'variable' 
	Object_Int* Int_gen_25 = NULL; // Default New Var reg of type: Int
	Int_gen_25 = ( (Object_Int* )Int_gen_20); 
	 // Assigning var result to Int_gen_25
	Int_gen_19 = Int_gen_25;
// End Assignment Statment
// Begin Method Call Generation .
	Object_Int* Int_gen_26 = NULL; // Default New Var reg of type: Int
	Object_Int* Int_gen_27 = NULL; // Default New Var reg of type: Int
	Int_gen_27 = ( (Object_Int* )Int_gen_19); 
// Setting variable Int_gen_19 to the new value
	Int_gen_19 = Int_gen_27;
Int_gen_26 = Int_gen_27; // generate method left exp complete.
	Object_Obj* Obj_gen_0 = NULL; // Default New Var reg of type: Obj
	Obj_gen_0 = ( (Object_Obj* )Int_gen_26); 
...
int main(int argc, char * argv[])
{
	...
	GLOBAL_Class_Factorial.Class_Factorial_Method_Factorial=Class_Factorial_Method_Factorial;
	GLOBAL_Class_Factorial.Class_Obj_Method_STR=Class_Obj_Method_STR;
	GLOBAL_Class_Factorial.Class_Obj_Method_PRINT=Class_Obj_Method_PRINT;
	GLOBAL_Class_Factorial.Class_Factorial_Method_fact=Class_Factorial_Method_fact;
